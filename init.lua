...
require('lazy').setup({
    ...
    config = function()
      ...
      vim.api.nvim_create_autocmd('LspAttach', {
        ...
        callback = function(event)
          require('fidget').notify('LspAttached!!', nil, { annote = 'curt', key = 'foobar' })
  ...
  { -- Highlight, edit, and navigate code
    ...
    build = ':TSUpdate',
    opts = {
      ensure_installed = { 'bash', 'c', 'diff', 'html', 'lua', 'luadoc', 'markdown', 'markdown_inline', 'query', 'vim', 'vimdoc', 'nickel', 'cuda' },
  ...
  },
  {
    ...
    opts = function()
      ...
      metals_config.on_attach = function(client, bufnr)
        ...
        require('fidget').notify('metals LspAttached!!', nil, { annote = 'curt', key = 'foobar' })
      end
